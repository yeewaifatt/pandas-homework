...
1. Visit [Google Sheets](https://docs.google.com/spreadsheets/) and use the built-in Google Finance function to choose 3-5 stocks for your portfolio (see [here](https://support.google.com/docs/answer/3093281) for detailed info on how to extract data using GOOGLEFINANCE)
